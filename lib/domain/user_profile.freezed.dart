    ...
    return _then(_value.copyWith(
      ...
      profilePaths: profilePaths == freezed
          ...
          : profilePaths // ignore: cast_nullable_to_non_nullable
              as List<String>?,
      headerPaths: headerPaths == freezed
          ? _value.headerPaths
          : headerPaths // ignore: cast_nullable_to_non_nullable
              as List<String>?,
    ));
  }
}
...
class _$_UserProfile extends _UserProfile with DiagnosticableTreeMixin {
  ...
  List<String>? get profilePaths {
    final value = _profilePaths;
    if (value == null) return null;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<String>? _headerPaths;
  @override
  List<String>? get headerPaths {
    final value = _headerPaths;
    if (value == null) return null;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
